...
})({"iXW5e":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "77fce9702788f56f";
"use strict";
...
},{}],"6Aagq":[function(require,module,exports,__globalThis) {
var _mainElm = require("./src/Main.elm");
const apiBaseUrl = "http://localhost:8080".replace(/\/$/, "");
...
},{"./src/Main.elm":"bDsJF"}],"bDsJF":[function(require,module,exports,__globalThis) {
(function(scope) {
    'use strict';
...
*/ var _Scheduler_working = false;
    ...
    var $author$project$ServiceHealth$Checking = {
        $: 'Checking'
    };
    var $author$project$View$Theme$Light = {
        $: 'Light'
    };
    var $author$project$Motorcycle$Model$Loading = {
        $: 'Loading'
    };
    var $author$project$View$MotorcyclePage = {
        $: 'MotorcyclePage'
    };
    var $author$project$Main$defaultApiBaseUrl = 'http://localhost:8080';
    var $author$project$Robot$Model$North = {
        $: 'North'
    };
    var $author$project$Robot$Model$Robot = function(a) {
        return {
            $: 'Robot',
            a: a
        };
    };
    var $author$project$Robot$Model$Zero = {
        $: 'Zero'
    };
    var $author$project$Robot$Model$initialRobot = $author$project$Robot$Model$Robot({
        facing: $author$project$Robot$Model$North,
        x: $author$project$Robot$Model$Zero,
        y: $author$project$Robot$Model$Zero
    });
    var $author$project$Robot$initialModel = {
        history: _List_Nil,
        robot: $author$project$Robot$Model$initialRobot
    };
    var $author$project$Main$initModel = {
        apiBaseUrl: $author$project$Main$defaultApiBaseUrl,
        currentPage: $author$project$View$MotorcyclePage,
        motorcycleProducts: $author$project$Motorcycle$Model$Loading,
        robot: $author$project$Robot$initialModel,
        serviceHealth: $author$project$ServiceHealth$Checking,
        themeMode: $author$project$View$Theme$Light,
        viewport: {
            height: 0,
            width: 0
        }
    };
    var $author$project$Main$ReceiveHealth = function(a) {
        return {
            $: 'ReceiveHealth',
            a: a
        };
    ...
    var $author$project$Generated$Api$HealthResponse$HealthResponse = function(status) {
        return {
            status: status
        };
    };
    var $author$project$Json$Decode$Pipeline$required = F3(function(fieldName, fieldDecoder, accumulatedDecoder) {
        return A3($elm$json$Json$Decode$map2, $elm$core$Basics$apL, accumulatedDecoder, A2($elm$json$Json$Decode$field, fieldName, fieldDecoder));
    });
    var $author$project$Generated$Api$HealthResponse$healthResponseDecoder = A3($author$project$Json$Decode$Pipeline$required, 'status', $elm$json$Json$Decode$string, $elm$json$Json$Decode$succeed($author$project$Generated$Api$HealthResponse$HealthResponse));
    var $elm$core$String$endsWith = _String_endsWith;
    var $author$project$Api$Health$healthUrl = function(apiBaseUrl) {
        return A2($elm$core$String$endsWith, '/', apiBaseUrl) ? apiBaseUrl + 'health' : apiBaseUrl + '/health';
    };
    var $author$project$Api$Health$getHealth = F2(function(apiBaseUrl, toMsg) {
        return $elm$http$Http$get({
            expect: A2($elm$http$Http$expectJson, toMsg, $author$project$Generated$Api$HealthResponse$healthResponseDecoder),
            url: $author$project$Api$Health$healthUrl(apiBaseUrl)
        });
    });
    var $author$project$Main$loadHealth = function(apiBaseUrl) {
        return A2($author$project$Api$Health$getHealth, apiBaseUrl, $author$project$Main$ReceiveHealth);
    };
    var $author$project$Main$ReceiveProducts = function(a) {
        return {
            $: 'ReceiveProducts',
            a: a
        };
    };
    var $author$project$Generated$Api$Product$Product = F6(function(id, name, category, priceCents, currency, imageUrl) {
        return {
            category: category,
            currency: currency,
            id: id,
    ...
    var $author$project$Generated$Api$Product$productDecoder = A3($author$project$Json$Decode$Pipeline$required, 'imageUrl', $elm$json$Json$Decode$string, A3($author$project$Json$Decode$Pipeline$required, 'currency', $elm$json$Json$Decode$string, A3($author$project$Json$Decode$Pipeline$required, 'priceCents', $elm$json$Json$Decode$int, A3($author$project$Json$Decode$Pipeline$required, 'category', $elm$json$Json$Decode$string, A3($author$project$Json$Decode$Pipeline$required, 'name', $elm$json$Json$Decode$string, A3($author$project$Json$Decode$Pipeline$required, 'id', $elm$json$Json$Decode$int, $elm$json$Json$Decode$succeed($author$project$Generated$Api$Product$Product)))))));
    var $author$project$Api$Products$productsUrl = function(apiBaseUrl) {
        return A2($elm$core$String$endsWith, '/', apiBaseUrl) ? apiBaseUrl + 'products' : apiBaseUrl + '/products';
    };
    var $author$project$Api$Products$getProducts = F2(function(apiBaseUrl, toMsg) {
        return $elm$http$Http$get({
            expect: A2($elm$http$Http$expectJson, toMsg, $elm$json$Json$Decode$list($author$project$Generated$Api$Product$productDecoder)),
            url: $author$project$Api$Products$productsUrl(apiBaseUrl)
        });
    });
    var $author$project$Main$loadProducts = function(apiBaseUrl) {
        return A2($author$project$Api$Products$getProducts, apiBaseUrl, $author$project$Main$ReceiveProducts);
    };
    var $elm$core$String$dropRight = F2(function(n, string) {
        return n < 1 ? string : A3($elm$core$String$slice, 0, -n, string);
    });
    var $author$project$Main$normaliseApiBaseUrl = function(apiBaseUrl) {
        return $elm$core$String$isEmpty(apiBaseUrl) ? $author$project$Main$defaultApiBaseUrl : A2($elm$core$String$endsWith, '/', apiBaseUrl) ? A2($elm$core$String$dropRight, 1, apiBaseUrl) : apiBaseUrl;
    };
    var $author$project$Main$init = function(flags) {
        var apiBaseUrl = $author$project$Main$normaliseApiBaseUrl(flags.apiBaseUrl);
        var model = _Utils_update($author$project$Main$initModel, {
            apiBaseUrl: apiBaseUrl
        });
        return _Utils_Tuple2(model, $elm$core$Platform$Cmd$batch(_List_fromArray([
            $author$project$Main$loadHealth(apiBaseUrl),
            $author$project$Main$loadProducts(apiBaseUrl)
        ])));
    };
    var $author$project$Main$ResizeViewport = F2(function(a, b) {
        return {
            $: 'ResizeViewport',
            a: a,
            b: b
    ...
    var $author$project$Main$IgnoreKeyPress = {
        $: 'IgnoreKeyPress'
    };
    var $author$project$Main$KeyboardCommand = function(a) {
        return {
            $: 'KeyboardCommand',
            a: a
        };
    };
    var $author$project$Robot$Logic$MoveForwardCommand = {
        $: 'MoveForwardCommand'
    };
    var $author$project$Robot$Logic$TurnLeftCommand = {
        $: 'TurnLeftCommand'
    };
    var $author$project$Robot$Logic$TurnRightCommand = {
        $: 'TurnRightCommand'
    };
    var $author$project$Robot$Logic$commandFromKey = function(key) {
        switch(key){
            case 'ArrowUp':
                return $elm$core$Maybe$Just($author$project$Robot$Logic$MoveForwardCommand);
            case 'ArrowLeft':
                return $elm$core$Maybe$Just($author$project$Robot$Logic$TurnLeftCommand);
            case 'ArrowRight':
                return $elm$core$Maybe$Just($author$project$Robot$Logic$TurnRightCommand);
            default:
                return $elm$core$Maybe$Nothing;
        }
    };
    var $author$project$Main$keyPressToMsg = function(key) {
        var _v0 = $author$project$Robot$Logic$commandFromKey(key);
        if (_v0.$ === 'Just') {
            var command = _v0.a;
            return $author$project$Main$KeyboardCommand(command);
        } else return $author$project$Main$IgnoreKeyPress;
    };
    var $author$project$Main$keyboardCommandsEnabled = function(currentPage) {
        if (currentPage.$ === 'RobotPage') return true;
        else return false;
    };
    ...
    var $author$project$Main$subscriptions = function(model) {
        return $elm$core$Platform$Sub$batch(_List_fromArray([
            $elm$browser$Browser$Events$onResize($author$project$Main$ResizeViewport),
            $author$project$Main$keyboardCommandsEnabled(model.currentPage) ? $elm$browser$Browser$Events$onKeyDown(A2($elm$json$Json$Decode$map, $author$project$Main$keyPressToMsg, A2($elm$json$Json$Decode$field, 'key', $elm$json$Json$Decode$string))) : $elm$core$Platform$Sub$none
        ]));
    };
    var $author$project$Robot$ApplyCommand = function(a) {
        return {
            $: 'ApplyCommand',
            a: a
        };
    };
    var $author$project$ServiceHealth$Available = function(a) {
        return {
            $: 'Available',
            a: a
        };
    };
    var $author$project$ServiceHealth$Unavailable = function(a) {
        return {
            $: 'Unavailable',
            a: a
        };
    };
    var $author$project$Main$httpErrorMessage = F2(function(apiBaseUrl, error) {
        switch(error.$){
            case 'BadUrl':
                return 'Check the frontend API URL.';
            case 'Timeout':
                return 'The request timed out.';
            case 'NetworkError':
                return 'Check that the product service is reachable at ' + (apiBaseUrl + '.');
            case 'BadStatus':
                var statusCode = error.a;
                return 'The service returned HTTP ' + ($elm$core$String$fromInt(statusCode) + '.');
            default:
                return 'The service returned unexpected JSON.';
        }
    });
    var $author$project$Main$healthStateFromResult = F2(function(apiBaseUrl, result) {
        if (result.$ === 'Ok') {
            var response = result.a;
            return $author$project$ServiceHealth$Available(response.status);
        } else {
            var error = result.a;
            return $author$project$ServiceHealth$Unavailable(A2($author$project$Main$httpErrorMessage, apiBaseUrl, error));
        }
    });
    var $author$project$Motorcycle$Model$Failed = function(a) {
        return {
            $: 'Failed',
            a: a
        };
    };
    var $author$project$Motorcycle$Model$Loaded = function(a) {
        return {
            $: 'Loaded',
            a: a
        };
    };
    var $author$project$Main$productStateFromResult = F2(function(apiBaseUrl, result) {
        if (result.$ === 'Ok') {
            var products = result.a;
            return $author$project$Motorcycle$Model$Loaded(products);
        } else {
            var error = result.a;
            return $author$project$Motorcycle$Model$Failed(A2($author$project$Main$httpErrorMessage, apiBaseUrl, error));
        }
    });
    var $author$project$Main$shouldRetryHealth = function(serviceHealth) {
    ...
    var $author$project$Main$shouldRetryProducts = function(productState) {
        switch(productState.$){
            case 'Failed':
                return true;
            case 'Loading':
    ...
    var $author$project$Robot$Model$One = {
        $: 'One'
    };
    var $author$project$Robot$Model$Three = {
        $: 'Three'
    };
    var $author$project$Robot$Model$Two = {
        $: 'Two'
    };
    var $author$project$Robot$Model$decrement = function(coordinate) {
        switch(coordinate.$){
            case 'Zero':
                return $author$project$Robot$Model$Zero;
            case 'One':
                return $author$project$Robot$Model$Zero;
            case 'Two':
                return $author$project$Robot$Model$One;
            case 'Three':
                return $author$project$Robot$Model$Two;
            default:
                return $author$project$Robot$Model$Three;
        }
    };
    var $author$project$Robot$Model$Four = {
        $: 'Four'
    };
    var $author$project$Robot$Model$increment = function(coordinate) {
        switch(coordinate.$){
            case 'Zero':
                return $author$project$Robot$Model$One;
            case 'One':
            ...
            case 'Two':
                return $author$project$Robot$Model$Three;
            case 'Three':
                return $author$project$Robot$Model$Four;
            default:
                return $author$project$Robot$Model$Four;
        }
    };
    var $author$project$Robot$Model$moveForward = function(robot) {
        var state = robot.a;
        var _v1 = state.facing;
        switch(_v1.$){
            case 'North':
                return $author$project$Robot$Model$Robot(_Utils_update(state, {
                    y: $author$project$Robot$Model$increment(state.y)
                }));
            case 'East':
                return $author$project$Robot$Model$Robot(_Utils_update(state, {
                    x: $author$project$Robot$Model$increment(state.x)
                }));
            case 'South':
                return $author$project$Robot$Model$Robot(_Utils_update(state, {
                    y: $author$project$Robot$Model$decrement(state.y)
                }));
            default:
                return $author$project$Robot$Model$Robot(_Utils_update(state, {
                    x: $author$project$Robot$Model$decrement(state.x)
                }));
        }
    };
    var $author$project$Robot$Model$East = {
        $: 'East'
    };
    var $author$project$Robot$Model$South = {
        $: 'South'
    };
    var $author$project$Robot$Model$West = {
        $: 'West'
    };
    var $author$project$Robot$Model$turnLeft = function(robot) {
        var state = robot.a;
        return $author$project$Robot$Model$Robot(_Utils_update(state, {
            facing: function() {
                var _v1 = state.facing;
                switch(_v1.$){
                    case 'North':
                        return $author$project$Robot$Model$West;
                    case 'West':
                        return $author$project$Robot$Model$South;
                    case 'South':
                        return $author$project$Robot$Model$East;
                    default:
                        return $author$project$Robot$Model$North;
                }
            }()
        }));
    };
    var $author$project$Robot$Model$turnRight = function(robot) {
        var state = robot.a;
        return $author$project$Robot$Model$Robot(_Utils_update(state, {
            facing: function() {
                var _v1 = state.facing;
    ...
    var $author$project$Robot$Logic$updateRobot = F2(function(command, robot) {
        switch(command.$){
            case 'MoveForwardCommand':
                return $author$project$Robot$Model$moveForward(robot);
            case 'TurnLeftCommand':
                return $author$project$Robot$Model$turnLeft(robot);
            default:
                return $author$project$Robot$Model$turnRight(robot);
        }
    });
    var $author$project$Robot$Logic$applyCommand = F2(function(command, model) {
        var updatedRobot = A2($author$project$Robot$Logic$updateRobot, command, model.robot);
        return _Utils_eq(updatedRobot, model.robot) ? model : _Utils_update(model, {
            history: A2($elm$core$List$cons, {
                command: command,
    ...
    var $author$project$Robot$Logic$undo = function(model) {
        var _v0 = model.history;
        if (_v0.b) {
            var latestEntry = _v0.a;
            var restOfHistory = _v0.b;
            return _Utils_update(model, {
    ...
    var $author$project$Robot$update = F2(function(msg, model) {
        switch(msg.$){
            case 'MoveForward':
                return A2($author$project$Robot$Logic$applyCommand, $author$project$Robot$Logic$MoveForwardCommand, model);
            case 'TurnLeft':
                return A2($author$project$Robot$Logic$applyCommand, $author$project$Robot$Logic$TurnLeftCommand, model);
            case 'TurnRight':
                return A2($author$project$Robot$Logic$applyCommand, $author$project$Robot$Logic$TurnRightCommand, model);
            case 'Undo':
                return $author$project$Robot$Logic$undo(model);
            case 'Reset':
                return $author$project$Robot$initialModel;
            default:
                var command = msg.a;
                return A2($author$project$Robot$Logic$applyCommand, command, model);
        }
    });
    var $author$project$Main$update = F2(function(msg, model) {
        switch(msg.$){
            case 'RobotMsg':
                var robotMsg = msg.a;
                return _Utils_Tuple2(_Utils_update(model, {
                    robot: A2($author$project$Robot$update, robotMsg, model.robot)
                }), $elm$core$Platform$Cmd$none);
            case 'KeyboardCommand':
                var command = msg.a;
                return _Utils_Tuple2(_Utils_update(model, {
                    robot: A2($author$project$Robot$update, $author$project$Robot$ApplyCommand(command), model.robot)
                }), $elm$core$Platform$Cmd$none);
            case 'IgnoreKeyPress':
                return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
            case 'SetTheme':
            ...
            case 'SelectPage':
                ...
                var retryProducts = _Utils_eq(selectedPage, $author$project$View$MotorcyclePage) && $author$project$Main$shouldRetryProducts(model.motorcycleProducts);
                var retryHealth = _Utils_eq(selectedPage, $author$project$View$MotorcyclePage) && $author$project$Main$shouldRetryHealth(model.serviceHealth);
                return _Utils_Tuple2(_Utils_update(model, {
                    currentPage: selectedPage,
                    motorcycleProducts: retryProducts ? $author$project$Motorcycle$Model$Loading : model.motorcycleProducts,
                    serviceHealth: retryHealth ? $author$project$ServiceHealth$Checking : model.serviceHealth
                }), retryProducts || retryHealth ? $elm$core$Platform$Cmd$batch(_List_fromArray([
                    retryHealth ? $author$project$Main$loadHealth(model.apiBaseUrl) : $elm$core$Platform$Cmd$none,
                    retryProducts ? $author$project$Main$loadProducts(model.apiBaseUrl) : $elm$core$Platform$Cmd$none
                ])) : $elm$core$Platform$Cmd$none);
            case 'ResizeViewport':
                var width = msg.a;
                var height = msg.b;
            ...
            case 'ReceiveHealth':
                var result = msg.a;
                return _Utils_Tuple2(_Utils_update(model, {
                    serviceHealth: A2($author$project$Main$healthStateFromResult, model.apiBaseUrl, result)
                }), $elm$core$Platform$Cmd$none);
            default:
                var result = msg.a;
                return _Utils_Tuple2(_Utils_update(model, {
                    motorcycleProducts: A2($author$project$Main$productStateFromResult, model.apiBaseUrl, result)
                }), $elm$core$Platform$Cmd$none);
        }
    });
    var $author$project$Main$RobotMsg = function(a) {
        return {
            $: 'RobotMsg',
            a: a
        };
    ...
    var $author$project$Robot$MoveForward = {
        $: 'MoveForward'
    };
    var $author$project$Robot$Reset = {
        $: 'Reset'
    };
    var $author$project$Robot$TurnLeft = {
        $: 'TurnLeft'
    };
    var $author$project$Robot$TurnRight = {
        $: 'TurnRight'
    };
    var $author$project$Robot$Undo = {
        $: 'Undo'
    };
    var $author$project$Robot$controls = function(toMsg) {
        return {
            moveForward: toMsg($author$project$Robot$MoveForward),
            reset: toMsg($author$project$Robot$Reset),
            turnLeft: toMsg($author$project$Robot$TurnLeft),
            turnRight: toMsg($author$project$Robot$TurnRight),
            undo: toMsg($author$project$Robot$Undo)
        };
    };
    ...
    var $mdgriffith$elm_ui$Internal$Model$Bottom = {
        $: 'Bottom'
    };
    ...
    var $author$project$Motorcycle$Model$currencySymbol = function(currency) {
        switch(currency){
            case 'USD':
                return '$';
            case 'AUD':
    ...
    var $author$project$Motorcycle$Model$priceLabel = function(product) {
        var centsText = A3($elm$core$String$padLeft, 2, _Utils_chr('0'), $elm$core$String$fromInt(product.priceCents % 100));
        return $author$project$Motorcycle$Model$currencySymbol(product.currency) + ($elm$core$String$fromInt(product.priceCents / 100 | 0) + ('.' + centsText));
    };
    ...
    var $author$project$Motorcycle$productPanel = F3(function(compactLayout, colors, panel) {
        var panelWidth = compactLayout ? $mdgriffith$elm_ui$Element$fill : $mdgriffith$elm_ui$Element$px(280);
        var panelHeight = compactLayout ? 396 : 452;
        var imageHeight = compactLayout ? 188 : 236;
        return A2($mdgriffith$elm_ui$Element$column, _List_fromArray([
            $mdgriffith$elm_ui$Element$width(panelWidth),
            $mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$px(panelHeight)),
            $mdgriffith$elm_ui$Element$spacing(28),
            $mdgriffith$elm_ui$Element$padding(28),
            $mdgriffith$elm_ui$Element$Background$color(colors.panelBackground),
            $mdgriffith$elm_ui$Element$Border$width(1),
            $mdgriffith$elm_ui$Element$Border$rounded(24),
            $mdgriffith$elm_ui$Element$Border$color(colors.panelBorder)
        ]), _List_fromArray([
            A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
                $mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$px(imageHeight)),
            ...
            A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                ...
                $mdgriffith$elm_ui$Element$Font$color(colors.detailText)
            ]), $mdgriffith$elm_ui$Element$text(panel.category)),
            A2($mdgriffith$elm_ui$Element$paragraph, _List_fromArray([
                $mdgriffith$elm_ui$Element$Font$size(24),
                $mdgriffith$elm_ui$Element$Font$color(colors.bodyText),
                $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
                $mdgriffith$elm_ui$Element$spacing(6)
            ]), _List_fromArray([
                $mdgriffith$elm_ui$Element$text(panel.name)
            ])),
            A2($mdgriffith$elm_ui$Element$paragraph, _List_fromArray([
                ...
                $mdgriffith$elm_ui$Element$text($author$project$Motorcycle$Model$priceLabel(panel))
            ])),
            A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                $mdgriffith$elm_ui$Element$alignBottom,
                $mdgriffith$elm_ui$Element$Font$size(13),
                $mdgriffith$elm_ui$Element$Font$color(colors.detailText)
            ]), $mdgriffith$elm_ui$Element$text('Product #' + $elm$core$String$fromInt(panel.id)))
        ]));
    });
    ...
    var $author$project$Motorcycle$productPanelLayout = F3(function(compactLayout, colors, productState) {
        var panels = function() {
            switch(productState.$){
                case 'Loaded':
                    var loadedProducts = productState.a;
                    return A2($elm$core$List$map, A2($author$project$Motorcycle$productPanel, compactLayout, colors), loadedProducts);
                case 'Loading':
                    return _List_Nil;
                default:
                    return _List_Nil;
        ...
        return compactLayout ? A2($mdgriffith$elm_ui$Element$column, _List_fromArray([
            $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
            $mdgriffith$elm_ui$Element$spacing(20)
        ]), panels) : A2($mdgriffith$elm_ui$Element$wrappedRow, _List_fromArray([
            $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
            $mdgriffith$elm_ui$Element$spacing(20)
        ]), panels);
    });
    var $author$project$Motorcycle$statusPanel = F4(function(compactLayout, colors, serviceHealth, productState) {
        var productsMessage = function() {
            switch(productState.$){
                case 'Loading':
                    return ' Loading products from the local service.';
                case 'Loaded':
                    var loadedProducts = productState.a;
                    return ' Collection loaded. ' + ($elm$core$String$fromInt($elm$core$List$length(loadedProducts)) + ' products available.');
                default:
                    var reason = productState.a;
                    return ' Product service unavailable. ' + reason;
            }
        }();
        var healthMessage = function() {
            switch(serviceHealth.$){
                case 'Checking':
                    return 'Health check in progress.';
                case 'Available':
                    var status = serviceHealth.a;
                    return 'Service status: ' + (status + '.');
                default:
                    var reason = serviceHealth.a;
        ...
        return A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
            ...
            $mdgriffith$elm_ui$Element$Border$rounded(18),
            $mdgriffith$elm_ui$Element$Border$color(colors.panelBorder),
            $mdgriffith$elm_ui$Element$padding(compactLayout ? 18 : 20)
        ]), $mdgriffith$elm_ui$Element$text(_Utils_ap(healthMessage, productsMessage)));
    });
    var $mdgriffith$elm_ui$Internal$Model$Empty = {
        $: 'Empty'
    };
    var $mdgriffith$elm_ui$Element$none = $mdgriffith$elm_ui$Internal$Model$Empty;
    var $author$project$View$PageHeading$view = F3(function(compactLayout, colors, labelText) {
        return A2($mdgriffith$elm_ui$Element$column, _List_fromArray([
            $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
            $mdgriffith$elm_ui$Element$spacing(8)
        ]), _List_fromArray([
            A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                $mdgriffith$elm_ui$Element$Font$size(compactLayout ? 30 : 36)
            ]), $mdgriffith$elm_ui$Element$text(labelText)),
            A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
                $mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$px(1)),
                $mdgriffith$elm_ui$Element$Background$color(colors.panelBorder)
            ]), $mdgriffith$elm_ui$Element$none)
        ]));
    });
    var $author$project$Motorcycle$view = F4(function(compactLayout, colors, serviceHealth, productState) {
        return A2($mdgriffith$elm_ui$Element$column, _List_fromArray([
            $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
            $mdgriffith$elm_ui$Element$spacing(28),
            ...
            A3($author$project$View$PageHeading$view, compactLayout, colors, 'Motorcycle'),
            A4($author$project$Motorcycle$statusPanel, compactLayout, colors, serviceHealth, productState),
            A3($author$project$Motorcycle$productPanelLayout, compactLayout, colors, productState)
        ]));
    });
    ...
    var $author$project$Robot$View$directionName = function(direction) {
        switch(direction.$){
            case 'North':
                return 'North';
            case 'East':
    ...
    var $author$project$Robot$Model$facing = function(robot) {
        var state = robot.a;
        return state.facing;
    };
    ...
    var $author$project$Robot$View$directionSymbol = function(direction) {
        switch(direction.$){
            case 'North':
                return "\u2191";
            case 'East':
    ...
    var $author$project$Robot$View$robotMarker = F3(function(compactLayout, colors, robot) {
        return A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
            $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
            $mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
            $mdgriffith$elm_ui$Element$padding(compactLayout ? 8 : 10)
        ]), A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
            $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
            $mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
            $mdgriffith$elm_ui$Element$Border$width(2),
            $mdgriffith$elm_ui$Element$Border$rounded(999),
            $mdgriffith$elm_ui$Element$Border$color(colors.robotMarkerText)
        ]), A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
            $mdgriffith$elm_ui$Element$centerX,
            $mdgriffith$elm_ui$Element$centerY,
            $mdgriffith$elm_ui$Element$Font$size(compactLayout ? 18 : 22),
            $mdgriffith$elm_ui$Element$Font$color(colors.robotMarkerText)
        ]), $mdgriffith$elm_ui$Element$text($author$project$Robot$View$directionSymbol($author$project$Robot$Model$facing(robot))))));
    });
    var $author$project$Robot$Model$coordinateToInt = function(coordinate) {
        switch(coordinate.$){
            case 'Zero':
                return 0;
            case 'One':
    ...
    var $author$project$Robot$Model$x = function(robot) {
        var state = robot.a;
        return $author$project$Robot$Model$coordinateToInt(state.x);
    };
    var $author$project$Robot$Model$y = function(robot) {
        var state = robot.a;
        return $author$project$Robot$Model$coordinateToInt(state.y);
    };
    var $author$project$Robot$View$gridCell = F5(function(compactLayout, colors, robot, xCoordinate, yCoordinate) {
        var isRobot = _Utils_eq($author$project$Robot$Model$x(robot), xCoordinate) && _Utils_eq($author$project$Robot$Model$y(robot), yCoordinate);
        var cellSize = compactLayout ? 48 : 68;
        return A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
            $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$px(cellSize)),
            $mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$px(cellSize)),
            $mdgriffith$elm_ui$Element$Border$width(1),
            $mdgriffith$elm_ui$Element$Border$rounded(14),
            $mdgriffith$elm_ui$Element$Border$color(isRobot ? colors.robotAccent : colors.emptyCellBorder),
            $mdgriffith$elm_ui$Element$Background$color(isRobot ? colors.robotAccent : colors.emptyCellBackground)
        ]), isRobot ? A3($author$project$Robot$View$robotMarker, compactLayout, colors, robot) : $mdgriffith$elm_ui$Element$none);
    });
    ...
    var $author$project$Robot$View$gridRow = F4(function(compactLayout, colors, robot, yCoordinate) {
        return A2($mdgriffith$elm_ui$Element$row, _List_fromArray([
            $mdgriffith$elm_ui$Element$spacing(compactLayout ? 8 : 10)
        ]), A2($elm$core$List$map, function(xCoordinate) {
            return A5($author$project$Robot$View$gridCell, compactLayout, colors, robot, xCoordinate, yCoordinate);
        }, _List_fromArray([
            0,
            1,
            2,
    ...
    var $author$project$Robot$View$grid = F3(function(compactLayout, colors, robot) {
        return A2($mdgriffith$elm_ui$Element$column, _List_fromArray([
            $mdgriffith$elm_ui$Element$centerX,
            $mdgriffith$elm_ui$Element$spacing(compactLayout ? 8 : 10)
        ]), A2($elm$core$List$map, A3($author$project$Robot$View$gridRow, compactLayout, colors, robot), _List_fromArray([
            4,
            3,
            2,
            1,
    ...
    var $author$project$Robot$View$board = F3(function(compactLayout, colors, robot) {
        return A2($mdgriffith$elm_ui$Element$column, _List_fromArray([
            $mdgriffith$elm_ui$Element$centerX,
            $mdgriffith$elm_ui$Element$spacing(18),
            $mdgriffith$elm_ui$Element$padding(compactLayout ? 16 : 24),
            $mdgriffith$elm_ui$Element$Background$color(colors.panelBackground),
            $mdgriffith$elm_ui$Element$Border$width(1),
            $mdgriffith$elm_ui$Element$Border$rounded(28),
            $mdgriffith$elm_ui$Element$Border$color(colors.panelBorder)
        ]), _List_fromArray([
            A3($author$project$Robot$View$grid, compactLayout, colors, robot),
            A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                $mdgriffith$elm_ui$Element$centerX,
                $mdgriffith$elm_ui$Element$Font$size(13),
                $mdgriffith$elm_ui$Element$Font$color(colors.facingText)
            ]), $mdgriffith$elm_ui$Element$text('Facing ' + $author$project$Robot$View$directionName($author$project$Robot$Model$facing(robot))))
        ]));
    });
    var $author$project$Robot$Logic$label = function(command) {
        switch(command.$){
            case 'MoveForwardCommand':
                return 'Move Forward';
            case 'TurnLeftCommand':
    ...
    var $author$project$Robot$View$historyItem = F3(function(colors, isLatest, command) {
        return A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
            $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
            $mdgriffith$elm_ui$Element$Background$color(colors.buttonBackground),
            $mdgriffith$elm_ui$Element$Border$rounded(16),
            $mdgriffith$elm_ui$Element$Border$width(1),
            $mdgriffith$elm_ui$Element$Border$color(colors.buttonBorder),
            A2($mdgriffith$elm_ui$Element$paddingXY, 18, 12),
            $mdgriffith$elm_ui$Element$Font$size(14),
            $mdgriffith$elm_ui$Element$Font$color(colors.buttonText)
        ]), $mdgriffith$elm_ui$Element$text(isLatest ? 'Latest: ' + $author$project$Robot$Logic$label(command) : $author$project$Robot$Logic$label(command)));
    });
    ...
    var $author$project$Robot$View$commandHistory = F2(function(colors, history1) {
        return A2($mdgriffith$elm_ui$Element$column, _List_fromArray([
            $mdgriffith$elm_ui$Element$width(A2($mdgriffith$elm_ui$Element$maximum, 340, $mdgriffith$elm_ui$Element$fill)),
            $mdgriffith$elm_ui$Element$centerX,
            ...
            A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                $mdgriffith$elm_ui$Element$Font$size(14),
                $mdgriffith$elm_ui$Element$Font$color(colors.detailText)
            ]), $mdgriffith$elm_ui$Element$text('Command History')),
            function() {
                if (history1.b) {
                    var latest = history1.a;
                    var rest = history1.b;
                    return A2($mdgriffith$elm_ui$Element$column, _List_fromArray([
                        $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
                        $mdgriffith$elm_ui$Element$spacing(8)
                    ]), A2($elm$core$List$cons, A3($author$project$Robot$View$historyItem, colors, true, latest), A2($elm$core$List$map, A2($author$project$Robot$View$historyItem, colors, false), A2($elm$core$List$take, 5, rest))));
                } else return A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                    $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
                    $mdgriffith$elm_ui$Element$Background$color(colors.buttonBackground),
                    $mdgriffith$elm_ui$Element$Border$rounded(16),
                    $mdgriffith$elm_ui$Element$Border$width(1),
                    ...
                    $mdgriffith$elm_ui$Element$Font$size(14),
                    $mdgriffith$elm_ui$Element$Font$color(colors.buttonText)
                ]), $mdgriffith$elm_ui$Element$text('No commands yet'));
            }()
        ]));
    });
    var $author$project$Robot$Logic$canApplyCommand = F2(function(command, robot) {
        return !_Utils_eq(A2($author$project$Robot$Logic$updateRobot, command, robot), robot);
    });
    var $author$project$Robot$Logic$canUndo = function(history1) {
        return !$elm$core$List$isEmpty(history1);
    };
    ...
    var $author$project$Robot$View$controlButton = F3(function(colors, labelText, onPress) {
        return A2($mdgriffith$elm_ui$Element$Input$button, function() {
            if (onPress.$ === 'Just') return _List_fromArray([
                $mdgriffith$elm_ui$Element$Background$color(colors.buttonBackground),
                $mdgriffith$elm_ui$Element$Border$rounded(16),
                $mdgriffith$elm_ui$Element$Border$width(1),
                $mdgriffith$elm_ui$Element$Border$color(colors.buttonBorder),
                ...
                $mdgriffith$elm_ui$Element$Font$size(14),
                $mdgriffith$elm_ui$Element$Font$color(colors.detailText),
                $mdgriffith$elm_ui$Element$alpha(0.65),
                $mdgriffith$elm_ui$Element$htmlAttribute($elm$html$Html$Attributes$disabled(true)),
                $mdgriffith$elm_ui$Element$focused(_List_fromArray([
    ...
    var $author$project$Robot$View$controlRow = F3(function(colors, model, controls) {
        return A2($mdgriffith$elm_ui$Element$wrappedRow, _List_fromArray([
            $mdgriffith$elm_ui$Element$centerX,
            $mdgriffith$elm_ui$Element$spacing(12)
        ]), _List_fromArray([
            A3($author$project$Robot$View$controlButton, colors, 'Move Forward', A2($author$project$Robot$Logic$canApplyCommand, $author$project$Robot$Logic$MoveForwardCommand, model.robot) ? $elm$core$Maybe$Just(controls.moveForward) : $elm$core$Maybe$Nothing),
            A3($author$project$Robot$View$controlButton, colors, 'Turn Left', $elm$core$Maybe$Just(controls.turnLeft)),
            A3($author$project$Robot$View$controlButton, colors, 'Turn Right', $elm$core$Maybe$Just(controls.turnRight)),
            A3($author$project$Robot$View$controlButton, colors, 'Undo', $author$project$Robot$Logic$canUndo(model.history) ? $elm$core$Maybe$Just(controls.undo) : $elm$core$Maybe$Nothing),
            A3($author$project$Robot$View$controlButton, colors, 'Reset', $elm$core$Maybe$Just(controls.reset))
        ]));
    });
    var $author$project$Robot$View$view = F4(function(compactLayout, colors, model, controls) {
        return A2($mdgriffith$elm_ui$Element$column, _List_fromArray([
            $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
            $mdgriffith$elm_ui$Element$spacing(28),
            $mdgriffith$elm_ui$Element$paddingEach({
            ...
            A3($author$project$View$PageHeading$view, compactLayout, colors, 'Robot'),
            A3($author$project$Robot$View$board, compactLayout, colors, model.robot),
            A3($author$project$Robot$View$controlRow, colors, model, controls),
            A2($author$project$Robot$View$commandHistory, colors, A2($elm$core$List$map, function($) {
                return $.command;
            }, model.history))
        ]));
    });
    var $author$project$View$page = F4(function(model, colors, compactLayout, robotControls) {
        var _v0 = model.currentPage;
        if (_v0.$ === 'MotorcyclePage') return A4($author$project$Motorcycle$view, compactLayout, colors, model.serviceHealth, model.motorcycleProducts);
        else return A4($author$project$Robot$View$view, compactLayout, colors, model.robot, robotControls);
    });
    var $author$project$View$Shell$isCompact = function(viewportWidth) {
        return !!viewportWidth && viewportWidth < 760;
    };
    ...
    var $author$project$View$Theme$palette = function(mode) {
        if (mode.$ === 'Light') return {
            appBackground: A3($mdgriffith$elm_ui$Element$rgb255, 255, 255, 255),
            bodyText: A3($mdgriffith$elm_ui$Element$rgb255, 51, 51, 51),
            buttonBackground: A3($mdgriffith$elm_ui$Element$rgb255, 247, 247, 247),
            buttonBorder: A3($mdgriffith$elm_ui$Element$rgb255, 225, 225, 225),
            buttonText: A3($mdgriffith$elm_ui$Element$rgb255, 51, 51, 51),
            detailText: A3($mdgriffith$elm_ui$Element$rgb255, 112, 112, 112),
            emptyCellBackground: A3($mdgriffith$elm_ui$Element$rgb255, 247, 247, 247),
            emptyCellBorder: A3($mdgriffith$elm_ui$Element$rgb255, 225, 225, 225),
            facingText: A3($mdgriffith$elm_ui$Element$rgb255, 112, 112, 112),
            panelBackground: A3($mdgriffith$elm_ui$Element$rgb255, 247, 247, 247),
            panelBorder: A3($mdgriffith$elm_ui$Element$rgb255, 225, 225, 225),
            robotAccent: A3($mdgriffith$elm_ui$Element$rgb255, 78, 91, 86),
            robotMarkerText: A3($mdgriffith$elm_ui$Element$rgb255, 248, 245, 240),
            robotSubtleText: A3($mdgriffith$elm_ui$Element$rgb255, 225, 225, 225)
        };
        else return {
            appBackground: A3($mdgriffith$elm_ui$Element$rgb255, 31, 31, 29),
            bodyText: A3($mdgriffith$elm_ui$Element$rgb255, 232, 226, 216),
            buttonBackground: A3($mdgriffith$elm_ui$Element$rgb255, 55, 56, 52),
            buttonBorder: A3($mdgriffith$elm_ui$Element$rgb255, 92, 93, 87),
            buttonText: A3($mdgriffith$elm_ui$Element$rgb255, 232, 226, 216),
            detailText: A3($mdgriffith$elm_ui$Element$rgb255, 176, 168, 156),
            emptyCellBackground: A3($mdgriffith$elm_ui$Element$rgb255, 45, 46, 43),
            emptyCellBorder: A3($mdgriffith$elm_ui$Element$rgb255, 92, 93, 87),
            facingText: A3($mdgriffith$elm_ui$Element$rgb255, 188, 180, 169),
            panelBackground: A3($mdgriffith$elm_ui$Element$rgb255, 38, 39, 36),
            panelBorder: A3($mdgriffith$elm_ui$Element$rgb255, 80, 81, 76),
            robotAccent: A3($mdgriffith$elm_ui$Element$rgb255, 96, 110, 104),
            robotMarkerText: A3($mdgriffith$elm_ui$Element$rgb255, 241, 237, 230),
            robotSubtleText: A3($mdgriffith$elm_ui$Element$rgb255, 191, 184, 174)
        };
    };
    var $author$project$View$RobotPage = {
        $: 'RobotPage'
    };
    ...
    var $author$project$View$Shell$menuButton = F5(function(colors, currentPage, targetPage, label, config) {
        return A2($mdgriffith$elm_ui$Element$Input$button, _List_fromArray([
            $mdgriffith$elm_ui$Element$Background$color(colors.appBackground),
            ...
            $mdgriffith$elm_ui$Element$Border$color(_Utils_eq(currentPage, targetPage) ? colors.bodyText : colors.panelBorder),
            $mdgriffith$elm_ui$Element$paddingEach({
                bottom: 8,
                left: 0,
                right: 0,
            ...
            $mdgriffith$elm_ui$Element$Font$size(15),
            $mdgriffith$elm_ui$Element$Font$color(_Utils_eq(currentPage, targetPage) ? colors.bodyText : colors.detailText)
        ]), {
            label: $mdgriffith$elm_ui$Element$text(label),
            onPress: $elm$core$Maybe$Just(config.selectPage(targetPage))
        });
    });
    ...
    var $author$project$View$Theme$Dark = {
        $: 'Dark'
    };
    var $author$project$View$ThemeToggle$toggleThemeMode = function(mode) {
        if (mode.$ === 'Light') return $author$project$View$Theme$Dark;
        else return $author$project$View$Theme$Light;
    };
    var $author$project$View$ThemeToggle$Moon = {
        $: 'Moon'
    };
    var $author$project$View$ThemeToggle$Sun = {
        $: 'Sun'
    };
    var $author$project$View$ThemeToggle$themeToggleDescription = function(mode) {
        if (mode.$ === 'Light') return 'Switch to light theme';
        else return 'Switch to dark theme';
    };
    var $author$project$View$ThemeToggle$config = function(activeMode) {
        var nextMode = $author$project$View$ThemeToggle$toggleThemeMode(activeMode);
        return {
            description: $author$project$View$ThemeToggle$themeToggleDescription(nextMode),
            icon: function() {
                if (nextMode.$ === 'Light') return $author$project$View$ThemeToggle$Sun;
                else return $author$project$View$ThemeToggle$Moon;
            }(),
            nextMode: nextMode
        };
    };
    ...
    var $author$project$View$ThemeToggle$themeToggleIconSize = 24;
    var $author$project$View$ThemeToggle$themeToggleIconViewBox = '0 0 ' + ($elm$core$String$fromInt($author$project$View$ThemeToggle$themeToggleIconSize) + (' ' + $elm$core$String$fromInt($author$project$View$ThemeToggle$themeToggleIconSize)));
    ...
    var $author$project$View$Theme$toCssColor = function(color) {
        var rgba = $mdgriffith$elm_ui$Element$toRgb(color);
        return 'rgba(' + ($elm$core$String$fromInt($elm$core$Basics$round(rgba.red * 255)) + (', ' + ($elm$core$String$fromInt($elm$core$Basics$round(rgba.green * 255)) + (', ' + ($elm$core$String$fromInt($elm$core$Basics$round(rgba.blue * 255)) + (', ' + ($elm$core$String$fromFloat(rgba.alpha) + ')')))))));
    };
    var $elm$svg$Svg$Attributes$viewBox = _VirtualDom_attribute('viewBox');
    var $elm$svg$Svg$Attributes$width = _VirtualDom_attribute('width');
    var $elm$svg$Svg$Attributes$x = _VirtualDom_attribute('x');
    var $elm$svg$Svg$Attributes$y = _VirtualDom_attribute('y');
    var $author$project$View$ThemeToggle$moonIcon = function(colors) {
        var visibleMoonFill = 'white';
        var transparentFill = 'none';
        var shadowRadiusMultiplier = 1;
        var shadowOffsetY = -2.5;
        var shadowOffsetX = 4.75;
        var origin = '0';
        var moonRadius = 8.5;
        var shadowRadius = moonRadius * shadowRadiusMultiplier;
        var moonCenterY = 12;
        var shadowCenterY = moonCenterY + shadowOffsetY;
        var moonCenterX = 11.25;
        var shadowCenterX = moonCenterX + shadowOffsetX;
        var maskUnits = 'userSpaceOnUse';
        var maskId = 'theme-toggle-moon-mask';
        var maskReference = 'url(#' + (maskId + ')');
        var maskBackgroundFill = 'black';
        var fillColor = $author$project$View$Theme$toCssColor(colors.buttonText);
        return A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
            $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$px($author$project$View$ThemeToggle$themeToggleIconSize)),
            $mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$px($author$project$View$ThemeToggle$themeToggleIconSize))
        ]), $mdgriffith$elm_ui$Element$html(A2($elm$svg$Svg$svg, _List_fromArray([
            $elm$svg$Svg$Attributes$viewBox($author$project$View$ThemeToggle$themeToggleIconViewBox),
            $elm$svg$Svg$Attributes$width($elm$core$String$fromInt($author$project$View$ThemeToggle$themeToggleIconSize)),
            $elm$svg$Svg$Attributes$height($elm$core$String$fromInt($author$project$View$ThemeToggle$themeToggleIconSize)),
            $elm$svg$Svg$Attributes$fill(transparentFill)
        ]), _List_fromArray([
            A2($elm$svg$Svg$defs, _List_Nil, _List_fromArray([
                A2($elm$svg$Svg$mask, _List_fromArray([
                    $elm$svg$Svg$Attributes$id(maskId),
                    $elm$svg$Svg$Attributes$maskUnits(maskUnits),
                    $elm$svg$Svg$Attributes$x(origin),
                    $elm$svg$Svg$Attributes$y(origin),
                    $elm$svg$Svg$Attributes$width($elm$core$String$fromInt($author$project$View$ThemeToggle$themeToggleIconSize)),
                    $elm$svg$Svg$Attributes$height($elm$core$String$fromInt($author$project$View$ThemeToggle$themeToggleIconSize))
                ]), _List_fromArray([
                    A2($elm$svg$Svg$rect, _List_fromArray([
                        $elm$svg$Svg$Attributes$x(origin),
                        $elm$svg$Svg$Attributes$y(origin),
                        $elm$svg$Svg$Attributes$width($elm$core$String$fromInt($author$project$View$ThemeToggle$themeToggleIconSize)),
                        $elm$svg$Svg$Attributes$height($elm$core$String$fromInt($author$project$View$ThemeToggle$themeToggleIconSize)),
                        $elm$svg$Svg$Attributes$fill(maskBackgroundFill)
                    ]), _List_Nil),
                    A2($elm$svg$Svg$circle, _List_fromArray([
                        $elm$svg$Svg$Attributes$cx($elm$core$String$fromFloat(moonCenterX)),
                        $elm$svg$Svg$Attributes$cy($elm$core$String$fromFloat(moonCenterY)),
                        $elm$svg$Svg$Attributes$r($elm$core$String$fromFloat(moonRadius)),
                        $elm$svg$Svg$Attributes$fill(visibleMoonFill)
                    ]), _List_Nil),
                    A2($elm$svg$Svg$circle, _List_fromArray([
                        $elm$svg$Svg$Attributes$cx($elm$core$String$fromFloat(shadowCenterX)),
                        $elm$svg$Svg$Attributes$cy($elm$core$String$fromFloat(shadowCenterY)),
                        $elm$svg$Svg$Attributes$r($elm$core$String$fromFloat(shadowRadius)),
                        $elm$svg$Svg$Attributes$fill(maskBackgroundFill)
                    ]), _List_Nil)
                ]))
            ])),
            A2($elm$svg$Svg$circle, _List_fromArray([
                ...
                $elm$svg$Svg$Attributes$mask(maskReference)
            ]), _List_Nil)
        ]))));
    };
    ...
    var $author$project$View$ThemeToggle$sunIcon = function(colors) {
        var transparentFill = 'none';
        var sunBodyRadius = 4.5;
        var sunRadius = $elm$core$String$fromFloat(sunBodyRadius);
        var strokeWidth = 2;
        var sunOuterRadius = sunBodyRadius + strokeWidth / 2;
        var strokeLinecap = 'round';
        var strokeColor = $author$project$View$Theme$toCssColor(colors.buttonText);
        var rayVisibleGap = 4;
        var rayStartDistance = sunOuterRadius + rayVisibleGap;
        var rayLength = 2.5;
        var rayEndDistance = rayStartDistance + rayLength;
        var rayAnglesInDegrees = _List_fromArray([
            -90,
            -45,
            0,
            45,
        ...
        var center = 12;
        var centerCoordinate = $elm$core$String$fromFloat(center);
        var rayPoint = F2(function(distance, angleInDegrees) {
            var angleInRadians = $elm$core$Basics$degrees(angleInDegrees);
            return {
                x: center + distance * $elm$core$Basics$cos(angleInRadians),
                y: center + distance * $elm$core$Basics$sin(angleInRadians)
            };
        });
        var ray = function(angleInDegrees) {
            var startPoint = A2(rayPoint, rayStartDistance, angleInDegrees);
            var endPoint = A2(rayPoint, rayEndDistance, angleInDegrees);
            return A2($elm$svg$Svg$line, _List_fromArray([
                $elm$svg$Svg$Attributes$x1($elm$core$String$fromFloat(startPoint.x)),
                $elm$svg$Svg$Attributes$y1($elm$core$String$fromFloat(startPoint.y)),
                $elm$svg$Svg$Attributes$x2($elm$core$String$fromFloat(endPoint.x)),
                $elm$svg$Svg$Attributes$y2($elm$core$String$fromFloat(endPoint.y)),
                $elm$svg$Svg$Attributes$stroke(strokeColor),
                $elm$svg$Svg$Attributes$strokeWidth($elm$core$String$fromFloat(strokeWidth)),
                $elm$svg$Svg$Attributes$strokeLinecap(strokeLinecap)
            ]), _List_Nil);
        };
        return A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
            $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$px($author$project$View$ThemeToggle$themeToggleIconSize)),
            ...
            $elm$svg$Svg$Attributes$height($elm$core$String$fromInt($author$project$View$ThemeToggle$themeToggleIconSize)),
            $elm$svg$Svg$Attributes$fill(transparentFill)
        ]), A2($elm$core$List$cons, A2($elm$svg$Svg$circle, _List_fromArray([
            $elm$svg$Svg$Attributes$cx(centerCoordinate),
            $elm$svg$Svg$Attributes$cy(centerCoordinate),
            $elm$svg$Svg$Attributes$r(sunRadius),
            $elm$svg$Svg$Attributes$stroke(strokeColor),
            $elm$svg$Svg$Attributes$strokeWidth($elm$core$String$fromFloat(strokeWidth))
        ]), _List_Nil), A2($elm$core$List$map, ray, rayAnglesInDegrees)))));
    };
    var $author$project$View$ThemeToggle$themeToggleIcon = F2(function(colors, icon) {
        if (icon.$ === 'Sun') return $author$project$View$ThemeToggle$sunIcon(colors);
        else return $author$project$View$ThemeToggle$moonIcon(colors);
    });
    var $author$project$View$ThemeToggle$view = F3(function(colors, activeMode, onToggle) {
        var toggleConfig = $author$project$View$ThemeToggle$config(activeMode);
        return A2($mdgriffith$elm_ui$Element$Input$button, _List_fromArray([
            $mdgriffith$elm_ui$Element$Background$color(colors.buttonBackground),
            $mdgriffith$elm_ui$Element$Border$rounded(18),
            $mdgriffith$elm_ui$Element$Border$width(1),
            ...
            $mdgriffith$elm_ui$Element$Region$description(toggleConfig.description)
        ]), {
            label: A2($author$project$View$ThemeToggle$themeToggleIcon, colors, toggleConfig.icon),
            onPress: $elm$core$Maybe$Just(onToggle)
        });
    });
    var $author$project$View$Shell$siteHeader = F5(function(compactLayout, colors, currentPage, themeMode, config) {
        return compactLayout ? A2($mdgriffith$elm_ui$Element$column, _List_fromArray([
            $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
            $mdgriffith$elm_ui$Element$spacing(20),
            $mdgriffith$elm_ui$Element$paddingEach({
            ...
            A2($mdgriffith$elm_ui$Element$row, _List_fromArray([
                ...
                A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                    ...
                    $mdgriffith$elm_ui$Element$centerY
                ]), $mdgriffith$elm_ui$Element$text('Fitzbeach')),
                A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                    $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
                ]), $mdgriffith$elm_ui$Element$none),
                A3($author$project$View$ThemeToggle$view, colors, themeMode, config.setTheme($author$project$View$ThemeToggle$toggleThemeMode(themeMode)))
            ])),
            A2($mdgriffith$elm_ui$Element$row, _List_fromArray([
                $mdgriffith$elm_ui$Element$spacing(24),
                $mdgriffith$elm_ui$Element$centerY
            ]), _List_fromArray([
                A5($author$project$View$Shell$menuButton, colors, currentPage, $author$project$View$MotorcyclePage, 'Motorcycle', config),
                A5($author$project$View$Shell$menuButton, colors, currentPage, $author$project$View$RobotPage, 'Robot', config)
            ]))
        ])) : A2($mdgriffith$elm_ui$Element$row, _List_fromArray([
            $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
            $mdgriffith$elm_ui$Element$paddingEach({
    ...
    var $author$project$View$Shell$view = function(config) {
        var compactLayout = $author$project$View$Shell$isCompact(config.viewport.width);
        var horizontalPadding = compactLayout ? 20 : 40;
        var verticalPadding = compactLayout ? 24 : 40;
        var colors = $author$project$View$Theme$palette(config.themeMode);
        return A2($mdgriffith$elm_ui$Element$layout, _List_Nil, A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
            $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
            $mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
            $mdgriffith$elm_ui$Element$Background$color(colors.appBackground),
            $mdgriffith$elm_ui$Element$Font$color(colors.bodyText)
        ]), A2($mdgriffith$elm_ui$Element$column, _List_fromArray([
            $mdgriffith$elm_ui$Element$width(A2($mdgriffith$elm_ui$Element$maximum, 1180, $mdgriffith$elm_ui$Element$fill)),
            $mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
            $mdgriffith$elm_ui$Element$centerX,
            $mdgriffith$elm_ui$Element$spacing(40),
            A2($mdgriffith$elm_ui$Element$paddingXY, horizontalPadding, verticalPadding)
        ]), _List_fromArray([
            A5($author$project$View$Shell$siteHeader, compactLayout, colors, config.currentPage, config.themeMode, config),
            A2(config.content, colors, compactLayout)
        ]))));
    };
    var $author$project$Main$view = function(model) {
        return $author$project$View$Shell$view({
            content: F2(function(colors, compactLayout) {
                return A4($author$project$View$page, model, colors, compactLayout, $author$project$Robot$controls($author$project$Main$RobotMsg));
            }),
            currentPage: model.currentPage,
            selectPage: $author$project$Main$SelectPage,
            setTheme: $author$project$Main$SetTheme,
    ...
    _Platform_export({
        'Main': {
            'init': $author$project$Main$main(A2($elm$json$Json$Decode$andThen, function(apiBaseUrl) {
                ...
                "types": {
                    "message": "Main.Msg",
                    "aliases": {
                        "Generated.Api.HealthResponse.HealthResponse": {
                            "args": [],
                            "type": "{ status : String.String }"
                        },
                        "Generated.Api.Product.Product": {
                            "args": [],
                            "type": "{ id : Basics.Int, name : String.String, category : String.String, priceCents : Basics.Int, currency : String.String, imageUrl : String.String }"
                        }
                    },
                    "unions": {
                        "Main.Msg": {
                            ...
                            "tags": {
                                ...
                                "ReceiveHealth": [
                                    "Result.Result Http.Error Generated.Api.HealthResponse.HealthResponse"
                                ],
                                "ReceiveProducts": [
                                    "Result.Result Http.Error (List.List Generated.Api.Product.Product)"
                                ]
                            }
                        },
                        "Robot.Logic.Command": {
...
},{}]},["iXW5e","6Aagq"], "6Aagq", "parcelRequire1430", {})

//# sourceMappingURL=frontend.2788f56f.js.map
