...
},{"./src/Main.elm":"c91t4"}],"c91t4":[function(require,module,exports,__globalThis) {
(function(scope) {
    'use strict';
...
*/ var _Scheduler_working = false;
    ...
    var $author$project$Motorcycle$Page$products = _List_fromArray([
        {
    ...
    var $author$project$Main$initialMotorcycleFeed = {
        pendingProducts: $author$project$Motorcycle$Page$products,
        visibleProducts: _List_Nil
    };
    ...
    var $author$project$Main$initModel = {
        ...
        history: _List_Nil,
        motorcycleFeed: $author$project$Main$initialMotorcycleFeed,
    ...
    var $author$project$Main$ReceiveNextProduct = {
        $: 'ReceiveNextProduct'
    };
    ...
    var $author$project$Main$subscriptions = function(model) {
        return $elm$core$Platform$Sub$batch(_List_fromArray([
            ...
            !_Utils_eq(model.currentPage, $author$project$View$MotorcyclePage) || $elm$core$List$isEmpty(model.motorcycleFeed.pendingProducts) ? $elm$core$Platform$Sub$none : A2($elm$time$Time$every, 250, function(_v0) {
                return $author$project$Main$ReceiveNextProduct;
            }),
            function() {
                var _v1 = model.currentPage;
                if (_v1.$ === 'RobotPage') return $elm$browser$Browser$Events$onKeyDown(A2($elm$json$Json$Decode$map, $author$project$Main$keyPressToMsg, A2($elm$json$Json$Decode$field, 'key', $elm$json$Json$Decode$string)));
    ...
    var $author$project$Main$receiveNextProduct = function(feed) {
        var _v0 = feed.pendingProducts;
        if (_v0.b) {
            var nextProduct = _v0.a;
            var remainingProducts = _v0.b;
            return {
                pendingProducts: remainingProducts,
                visibleProducts: _Utils_ap(feed.visibleProducts, _List_fromArray([
                    nextProduct
                ]))
            };
        } else return feed;
    ...
    var $author$project$Main$update = F2(function(msg, model) {
        switch(msg.$){
            case 'MoveForward':
                return _Utils_Tuple2(A2($author$project$Robot$Logic$applyCommand, $author$project$Robot$Logic$MoveForwardCommand, model), $elm$core$Platform$Cmd$none);
            case 'TurnLeft':
                return _Utils_Tuple2(A2($author$project$Robot$Logic$applyCommand, $author$project$Robot$Logic$TurnLeftCommand, model), $elm$core$Platform$Cmd$none);
            case 'TurnRight':
                return _Utils_Tuple2(A2($author$project$Robot$Logic$applyCommand, $author$project$Robot$Logic$TurnRightCommand, model), $elm$core$Platform$Cmd$none);
            case 'KeyboardCommand':
                var command = msg.a;
                return _Utils_Tuple2(A2($author$project$Robot$Logic$applyCommand, command, model), $elm$core$Platform$Cmd$none);
            case 'IgnoreKeyPress':
                return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
            case 'Undo':
                return _Utils_Tuple2($author$project$Robot$Logic$undo(model), $elm$core$Platform$Cmd$none);
            case 'Reset':
                return _Utils_Tuple2(_Utils_update(model, {
                    history: _List_Nil,
                    robot: $author$project$Robot$Model$initialRobot
            ...
            case 'SelectPage':
                ...
                return _Utils_Tuple2(_Utils_update(model, {
                    ...
                    motorcycleFeed: _Utils_eq(selectedPage, $author$project$View$MotorcyclePage) ? $author$project$Main$initialMotorcycleFeed : model.motorcycleFeed
                }), $elm$core$Platform$Cmd$none);
            case 'ResizeViewport':
                var width = msg.a;
                var height = msg.b;
            ...
            default:
                return _Utils_Tuple2(_Utils_update(model, {
                    motorcycleFeed: $author$project$Main$receiveNextProduct(model.motorcycleFeed)
                }), $elm$core$Platform$Cmd$none);
        }
    });
    var $author$project$Main$MoveForward = {
        $: 'MoveForward'
    };
    var $author$project$Main$Reset = {
        $: 'Reset'
    };
    ...
    var $author$project$Main$TurnLeft = {
        $: 'TurnLeft'
    };
    var $author$project$Main$TurnRight = {
        $: 'TurnRight'
    };
    ...
    var $author$project$View$isCompact = function(viewportWidth) {
    ...
    var $author$project$Robot$View$controlRow = F3(function(colors, robot, controls) {
        return A2($mdgriffith$elm_ui$Element$wrappedRow, _List_fromArray([
            $mdgriffith$elm_ui$Element$centerX,
            $mdgriffith$elm_ui$Element$spacing(12)
        ]), _List_fromArray([
            A3($author$project$Robot$View$controlButton, colors, 'Move Forward', A2($author$project$Robot$Logic$canApplyCommand, $author$project$Robot$Logic$MoveForwardCommand, robot) ? $elm$core$Maybe$Just(controls.moveForward) : $elm$core$Maybe$Nothing),
            ...
            A3($author$project$Robot$View$controlButton, colors, 'Undo', $elm$core$Maybe$Just(controls.undo)),
    ...
    var $author$project$Robot$View$pageHeading = F3(function(compactLayout, colors, labelText) {
        return A2($mdgriffith$elm_ui$Element$column, _List_fromArray([
            $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
            $mdgriffith$elm_ui$Element$spacing(8)
        ]), _List_fromArray([
    ...
    var $author$project$Robot$View$page = F4(function(compactLayout, colors, model, controls) {
        return A2($mdgriffith$elm_ui$Element$column, _List_fromArray([
            $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
            ...
            A3($author$project$Robot$View$pageHeading, compactLayout, colors, 'Robot'),
            A3($author$project$Robot$View$board, compactLayout, colors, model.robot),
            A3($author$project$Robot$View$controlRow, colors, model.robot, controls),
            A2($author$project$Robot$View$commandHistory, colors, A2($elm$core$List$map, function($) {
                return $.command;
            }, model.history))
        ]));
    });
    var $author$project$Motorcycle$Page$loadingStatus = F3(function(colors, loadedProducts, isLoading) {
        var totalCount = $elm$core$List$length($author$project$Motorcycle$Page$products);
        return A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
            $mdgriffith$elm_ui$Element$Font$size(14),
            $mdgriffith$elm_ui$Element$Font$color(colors.detailText)
        ]), $mdgriffith$elm_ui$Element$text(isLoading ? 'Loading products... ' + ($elm$core$String$fromInt($elm$core$List$length(loadedProducts)) + (' of ' + $elm$core$String$fromInt(totalCount))) : 'Collection loaded. ' + ($elm$core$String$fromInt(totalCount) + ' products available.')));
    });
    var $author$project$Motorcycle$Page$pageHeading = F3(function(compactLayout, colors, labelText) {
        return A2($mdgriffith$elm_ui$Element$column, _List_fromArray([
            $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
            $mdgriffith$elm_ui$Element$spacing(8)
        ]), _List_fromArray([
    ...
    var $author$project$Motorcycle$Page$productPanel = F3(function(compactLayout, colors, panel) {
        ...
        return A2($mdgriffith$elm_ui$Element$column, _List_fromArray([
            ...
            A2($mdgriffith$elm_ui$Element$paragraph, _List_fromArray([
                ...
                $mdgriffith$elm_ui$Element$text(panel.price)
            ])),
            A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                $mdgriffith$elm_ui$Element$alignBottom,
                $mdgriffith$elm_ui$Element$Font$size(13),
                $mdgriffith$elm_ui$Element$Font$color(colors.detailText)
            ]), $mdgriffith$elm_ui$Element$text(panel.description))
        ]));
    });
    var $author$project$Motorcycle$Page$productPanelLayout = F3(function(compactLayout, colors, loadedProducts) {
        var panels = A2($elm$core$List$map, A2($author$project$Motorcycle$Page$productPanel, compactLayout, colors), loadedProducts);
    ...
    var $author$project$Motorcycle$Page$view = F4(function(compactLayout, colors, loadedProducts, isLoading) {
        return A2($mdgriffith$elm_ui$Element$column, _List_fromArray([
            $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
            $mdgriffith$elm_ui$Element$spacing(28),
            $mdgriffith$elm_ui$Element$paddingEach({
            ...
            A3($author$project$Motorcycle$Page$pageHeading, compactLayout, colors, 'Motorcycle'),
            A3($author$project$Motorcycle$Page$loadingStatus, colors, loadedProducts, isLoading),
            A3($author$project$Motorcycle$Page$productPanelLayout, compactLayout, colors, loadedProducts)
        ]));
    });
    var $author$project$View$pageBody = F4(function(compactLayout, colors, model, robotControls) {
        var _v0 = model.currentPage;
        if (_v0.$ === 'MotorcyclePage') return A4($author$project$Motorcycle$Page$view, compactLayout, colors, model.motorcycleFeed.visibleProducts, !$elm$core$List$isEmpty(model.motorcycleFeed.pendingProducts));
        else return A4($author$project$Robot$View$page, compactLayout, colors, model, robotControls);
    });
    ...
    var $author$project$View$menuButton = F5(function(colors, currentPage, targetPage, label, config) {
    ...
    var $author$project$View$ThemeToggle$themeToggleIcon = F2(function(colors, mode) {
        if (mode.$ === 'Light') return $author$project$View$ThemeToggle$sunIcon(colors);
    ...
    var $author$project$View$ThemeToggle$view = F3(function(colors, activeMode, onToggle) {
        ...
        return A2($mdgriffith$elm_ui$Element$Input$button, _List_fromArray([
            ...
            $mdgriffith$elm_ui$Element$Region$description($author$project$View$ThemeToggle$themeToggleDescription(nextMode))
        ]), {
            label: A2($author$project$View$ThemeToggle$themeToggleIcon, colors, nextMode),
            onPress: $elm$core$Maybe$Just(onToggle)
        });
    });
    var $author$project$View$siteHeader = F5(function(compactLayout, colors, currentPage, themeMode, config) {
        return compactLayout ? A2($mdgriffith$elm_ui$Element$column, _List_fromArray([
            $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
            $mdgriffith$elm_ui$Element$spacing(20),
            $mdgriffith$elm_ui$Element$paddingEach({
            ...
            A2($mdgriffith$elm_ui$Element$row, _List_fromArray([
                ...
                A5($author$project$View$menuButton, colors, currentPage, $author$project$View$MotorcyclePage, 'Motorcycle', config),
                A5($author$project$View$menuButton, colors, currentPage, $author$project$View$RobotPage, 'Robot', config)
            ]))
        ])) : A2($mdgriffith$elm_ui$Element$row, _List_fromArray([
            $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
            $mdgriffith$elm_ui$Element$paddingEach({
    ...
    var $author$project$View$page = F2(function(model, config) {
        var compactLayout = $author$project$View$isCompact(model.viewport.width);
        var horizontalPadding = compactLayout ? 20 : 40;
        var verticalPadding = compactLayout ? 24 : 40;
        var colors = $author$project$View$Theme$palette(model.themeMode);
        return A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
            $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
            $mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
            $mdgriffith$elm_ui$Element$Background$color(colors.appBackground),
            ...
            A5($author$project$View$siteHeader, compactLayout, colors, model.currentPage, model.themeMode, config),
            A4($author$project$View$pageBody, compactLayout, colors, model, config.robotControls)
        ])));
    });
    var $author$project$View$view = F2(function(model, config) {
        return A2($mdgriffith$elm_ui$Element$layout, _List_Nil, A2($author$project$View$page, model, config));
    });
    var $author$project$Main$view = function(model) {
        return A2($author$project$View$view, model, {
            robotControls: {
                moveForward: $author$project$Main$MoveForward,
                reset: $author$project$Main$Reset,
                turnLeft: $author$project$Main$TurnLeft,
                turnRight: $author$project$Main$TurnRight,
                undo: $author$project$Main$Undo
            },
...
},{}]},["kxwl6","jOXmm"], "jOXmm", "parcelRequire1430", {})

//# sourceMappingURL=fitzbeach.e02fbd41.js.map
